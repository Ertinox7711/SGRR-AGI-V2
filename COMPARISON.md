...
| **[davila7/claude-code-templates](https://github.com/davila7/claude-code-templates)** | ~27k | CLI + aitmpl.com dashboard, 400+ components (agents, hooks, settings, MCPs) | catalogue without unified philosophy; no secret scan; multi-step setup; no "proactive AGI" layer; English only |
