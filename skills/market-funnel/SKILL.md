---
name: market-funnel
description: Analyse et optimisation d'un tunnel de vente : trace le parcours complet de la premiere visite a l'achat, chiffre les points de fuite et propose des correctifs classes par gain estime. A invoquer quand on demande d'auditer un funnel ou de comprendre ou les visiteurs decrochent.
---
